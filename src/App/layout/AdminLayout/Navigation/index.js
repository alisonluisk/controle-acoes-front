...
const mapStateToProps = state => {
    return {
        ...
        preLayout: state.theme.preLayout,
        collapseMenu: state.theme.collapseMenu,
        layoutType: state.theme.layoutType,
        navBackColor: state.theme.navBackColor,
        navBackImage: state.theme.navBackImage,
        navIconColor: state.theme.navIconColor,
        navBrandColor: state.theme.navBrandColor,
        layout6Background: state.theme.layout6Background,
        layout6BackSize: state.theme.layout6BackSize,
        rtlLayout: state.theme.rtlLayout,
        navFixedLayout: state.theme.navFixedLayout,
        boxLayout: state.theme.boxLayout,
        navDropdownIcon: state.theme.navDropdownIcon,
        navListIcon: state.theme.navListIcon,
        navActiveListColor: state.theme.navActiveListColor,
        navListTitleColor: state.theme.navListTitleColor,
        navListTitleHide: state.theme.navListTitleHide
    }
};
